//This script have offline battles, max level bots, emotes in offline battles and lobbyInfo
...
rpc.exports = {
    init: function(stage, options) {
        ...
        onLoad('libg.so', function() {
            ...
            setup();
            toast("script By DemirCnq");
            enableDebugInfo();
           // packageName('com.server'); //packet name protection 
